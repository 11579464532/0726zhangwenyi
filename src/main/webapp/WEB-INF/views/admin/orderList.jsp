            ...
            <table class="table table-condensed">
                ...
                <c:forEach var="o" items="${orderList}">
                    <tr>
                        ...
                        <td>${o.orderDate}</td>
                        <%
                            com.zhangwenyi.model.Order o = (com.zhangwenyi.model.Order) pageContext.findAttribute("o");
                            int userId = o.getCustomerId();
                            java.sql.Connection con = (java.sql.Connection) application.getAttribute("con");
                            com.zhangwenyi.dao.UserDao userDao = new com.zhangwenyi.dao.UserDao();
                        ...
                        <td class="cart_total">${o.paymentId}
                            <%
                                ...
                                String paymentType = com.zhangwenyi.model.Payment.findByPaymentId(con, n);
                            %>
